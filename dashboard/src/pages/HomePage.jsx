  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-muted/40 bg-white">
      <aside className="fixed inset-y-0 left-0 hidden w-14 flex-col border-r bg-background sm:flex z-50">
        <nav className="flex flex-col items-center gap-4 p-5 bg-gray-800 h-screen text-white">
          <Link
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="right" className="bg-gray-950">Dashboard</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="right" className="bg-gray-950">Add Project</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="right" className="bg-gray-950">Add Skill</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="right" className="bg-gray-950">Add Uses</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="right" className="bg-gray-950">Add Timeline</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="right" className="bg-gray-950">Messages</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="right" className="bg-gray-950">Account</TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </nav>
