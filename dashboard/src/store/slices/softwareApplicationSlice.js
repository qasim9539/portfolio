...
export const getAllSoftwareApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${window.location.origin}/api/v1/softwareapplication/getall`,
...
export const addNewSoftwareApplication = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `${window.location.origin}/api/v1/softwareapplication/add`,
      data,
      {
        withCredentials: true,
...
export const deleteSoftwareApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `${window.location.origin}/api/v1/softwareapplication/delete/${id}`,
      {
        withCredentials: true,
      }
    );
