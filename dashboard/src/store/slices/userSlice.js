...
export const getUser = () => async (dispatch) => {
    ...
    try {
        const { data } = await axios.get(`${window.location.origin}/api/v1/user/me`, {
...
export const updatePassword = (currentPassword, newPassword, confirmNewPassword) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.put(
            `${window.location.origin}/api/v1/user/update/password`,
...
export const updateProfile = (data) => async (dispatch) => {
    ...
    try {
      const response = await axios.put(
        `${window.location.origin}/api/v1/user/update/me`,
        data,
        {
          withCredentials: true,
