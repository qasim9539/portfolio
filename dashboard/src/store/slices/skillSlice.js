...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${window.location.origin}/api/v1/skill/getall`,
...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `${window.location.origin}/api/v1/skill/add`,
      data,
      {
        withCredentials: true,
...
export const updateSkill = (id, proficiency) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `${window.location.origin}/api/v1/skill/update/${id}`,
      { proficiency },
      {
        withCredentials: true,
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
     `${window.location.origin}/api/v1/skill/delete/${id}`,
      {
        withCredentials: true,
      }
    );
