...
const Hero = () => {
  ...
  useEffect(() => {
    const getMyProfile = async () => {
      const { data } = await axios.get(
        `${window.location.origin}/api/v1/user/me/portfolio`,
  ...
  return (
    <div className="w-full">
      ...
      <h1 className="text-[1.3rem] overflow-x-hidden sm:text-[1.75rem] 
        md:text-[2.2rem] lg:text-[2.8rem] tracking-[2px] mb-4">
        Hey, I'm Muhammad Qasim Gardezi
      </h1>
      ...
      <div className="w-fit px-5 py-2 bg-slate-50 rounded-[20px] flex gap-5
        ...
        <Link to={"https://www.youtube.com/@Gardezitv786"} target="_blank">
